...
const RightTopics: FC<Props> = () => {
  return (
    <>
      ...
      <Card title="Recommended topics" bordered={false} style={{ width: 300 }}>
      ...
      <Card title="Reading list" bordered={false} style={{ width: 300 }}>
        <p>
          Click the <InboxOutlined /> on any story to easily add it to your
          reading list or a custom list that you can share.
        </p>
      </Card>
      <Card title="Who to follow" bordered={false} style={{ width: 300 }}>
        <Meta
          avatar={
